 ...
 */
public class SdHplStockOut extends AbstractDO {
    ...
    private Long whOutId;
    
    private String whOutName;
     ...
     * 
     */
    private Long redFormId;

    /**
     * 
     */
    private Long stockInFormId;
    ...
    public Long getWhOutId() {
        return whOutId;
    }

    public void setWhOutId(Long whOutId) {
    ...
    public Integer getFormQty() {
        return formQty;
    }

    public void setFormQty(Integer formQty) {
        this.formQty = formQty;
    }
    ...
    public Long getRedFormId() {
        return redFormId;
    }

    public void setRedFormId(Long redFormId) {
        this.redFormId = redFormId;
    }
    ...
    public Long getAccountBy() {
        return accountBy;
    }

    public void setAccountBy(Long accountBy) {
    ...
    public String getWhOutName() {
        return whOutName;
    }

    public void setWhOutName(String whOutName) {
        this.whOutName = whOutName;
    }
    ...
    public String toString() {
        return "SdHplStockOut [formId=" + formId + ", formNo=" + formNo + ", outType=" + outType + ", stockFlag="
                + stockFlag + ", areaId=" + areaId + ", sysId=" + sysId + ", periodNo=" + periodNo + ", whOutId="
                + whOutId + ", whOutName=" + whOutName + ", whId=" + whId + ", whName=" + whName + ", whSiteId="
                + whSiteId + ", whSiteName=" + whSiteName + ", deptId=" + deptId + ", deptNo=" + deptNo + ", deptName="
                + deptName + ", accountType=" + accountType + ", accountTypeName=" + accountTypeName + ", calcType="
                + calcType + ", calcTypeName=" + calcTypeName + ", fundsSource=" + fundsSource + ", fundsSourceName="
                + fundsSourceName + ", requestUser=" + requestUser + ", requestUserName=" + requestUserName
                + ", originalForm=" + originalForm + ", receiverType=" + receiverType + ", receiverNote=" + receiverNote
                + ", receiverName=" + receiverName + ", receiverAddr=" + receiverAddr + ", receiverPhone="
                + receiverPhone + ", formQty=" + formQty + ", formAmount=" + formAmount + ", outAmount=" + outAmount
                + ", formStatus=" + formStatus + ", formRemark=" + formRemark + ", printTimes=" + printTimes
                + ", redTimes=" + redTimes + ", redFlag=" + redFlag + ", redFormId=" + redFormId + ", stockInFormId="
                + stockInFormId + ", submitBy=" + submitBy + ", submitName=" + submitName + ", submitTime=" + submitTime
                + ", approveBy=" + approveBy + ", approveName=" + approveName + ", approveTime=" + approveTime
                + ", accountBy=" + accountBy + ", accountName=" + accountName + ", accountTime=" + accountTime
                + ", addBy=" + addBy + ", addName=" + addName + ", lastEditBy=" + lastEditBy + ", lastEditName="
                + lastEditName + ", lastEditTime=" + lastEditTime + ", deptRoomId=" + deptRoomId + ", inpatientNo="
                + inpatientNo + ", patientName=" + patientName + ", bedNo=" + bedNo + ", deptRoomName=" + deptRoomName
